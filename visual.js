...
class VisualJs {
   ...
   * @param {boolean} [setIcon=false] - decides whether the icon should displays or not 
   * @param {string} iconType 
   * @param {string} iconBackgroundColor 
   * @param {string} innerColor 
   */

  createSnackBar(message, backgroundColor, textColor, position, animationType = "fade", timeout = 3000, setIcon = false, iconType = null, iconBackgroundColor = null, innerColor = null) {
    //Create a reference to the html head element
    var head = document.head;
    ...
    document.getElementById("visual-button").addEventListener("click", showSnackBar);
    ...
    //Set attribute of the snackbar message container
    ...
    document.getElementById("visual-button").addEventListener("click", function () {
      // Get the snackbar DIV
      var snackbar = document.getElementById("snackbar")

      // Add the "show" class to the snackbar div
      snackbar.className = "show";

      // Set timeout after a specified period.
   ...
   * @param {number} [timeout=3000] - time it takes for the snackbar to disapper
  ...
  createGradientSnackBar(message, backgroundColor, startColor, endColor, position, animationType = "fade", timeout = 3000, setIcon = false, iconType = null, iconBackgroundColor = null, iconInnerColor = null) {
    //Create a reference to the html head element
    var head = document.head;
...
${position}: ${positionValue}; 
  ...
  setVisualAnimation(animationType, position) {
    ...
    to {${position}: 0; opacity: 0;}
      ...
      .show{
          visibility: visible !important;
         -webkit-animation:bounceIn 10s linear 0s 1 alternate forwards;
    animation: bounceIn 10s linear 0s 1 alternate forwards;
      }
...
window.showSnackBar = vJs.showSnackBar;
